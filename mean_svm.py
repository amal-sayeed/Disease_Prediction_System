...
precision_svm = precision_score(y_test, y_pred_svm, pos_label=4)  # Assuming 4 represents the malignant class
recall_svm = recall_score(y_test, y_pred_svm, pos_label=4)

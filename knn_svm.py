...
precision_svm = precision_score(y_test, y_pred, pos_label=4, zero_division=1)  # Assuming 4 represents the malignant class
recall_svm = recall_score(y_test, y_pred, pos_label=4)
